...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-x3z70ua.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-x3z70ua.containers.anotherwebservice.com/
...
```
git clone git@github.com:nafisaqil4/container-x3z70ua.git
cd container-x3z70ua
```
...
```
docker attach container-x3z70ua
```
